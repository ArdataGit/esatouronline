            ...
            <form action="{{ route('backend.invoice.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 mb-4">
                                        <label for="customer" class="form-label">Pelanggan</label><span
                                            style="color: red;">*</span>
                                        <button
                                            style="width: auto; padding: 5px 10px; font-size: 12px; float:right; margin-bottom: 2%;"
                                        ...
                                        <select id="customer_id" name="customer_id"
                                            ...
                                            @foreach ($customers as $item)
                                                <option
                                                    @isset($data) @if ($data->customer_id == $item->id) selected  @endif @endisset
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <label for="select2Basic" class="form-label">Tanggal Penerbitan</label><span
                                            style="color: red;">*</span>
                                        <input type="date" name="date_publisher" class="form-control" id="floatingInput"
                                            aria-describedby="floatingInputHelp" required
                                            @isset($data) value="{{ $data->date_publisher }}" @endisset />
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="date" name="due_date" class="form-control" id="floatingInput"
                                            ...
                                            @isset($data) value="{{ $data->due_date }}" @endisset />
                                    </div>

                                    <div class="col-md-3 mb-4">
                                        <label for="physical_invoice_id" class="form-label">Invoice Fisik</label><span
                                            style="color: red;">*</span>
                                        <select id="physical_invoice_id" class="select2 form-select form-select-lg"
                                            data-allow-clear="true" name="physical_invoice_id" required>
                                            <option>-- Pilih Invoice Fisik --</option>

                                            @foreach ($physical_invoie as $item)
                                                <option
                                                    @isset($data) @if ($data->physical_invoice_id == $item->id) selected  @endif @endisset
                                                    value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <label for="select2Basic" class="form-label">Nomor Invoice</label><span
                                            style="color: red;">*</span>
                                        <input type="text" class="form-control" id="floatingInput"
                                            aria-describedby="floatingInputHelp" name="invoice_number" required
                                            @isset($data) value="{{ $data->invoice_number }}" @endisset />
                                    </div>

                                    <div class="col-md-3 mb-4">
                                        <label for="status" class="form-label">Status Invoice</label><span
                                            style="color: red;">*</span>
                                        <select id="status" class="select2 form-select form-select-lg"
                                            data-allow-clear="true" name="status" required>
                                            <option>-- Pilih Status --</option>
                                            <option
                                                @isset($data) @if ($data->status == 'Aktif') selected  @endif @endisset
                                                value="Aktif">Aktif</option>
                                            <option
                                                @isset($data) @if ($data->status == 'Void') selected  @endif @endisset
                                                value="Void">Void</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <button id="addRowBtn" style="float:right; margin-bottom: 5%;" type="button"
                                ...
                                <div id="rowsContainer">
                                    <input type="hidden" name="invoice_id"
                                        @isset($data) value="{{ $data->id }}" @endisset>
                                    @if (isset($data_d))
                                        @foreach ($data_d as $key => $value)
                                            <div class="row item-row" style="margin-top: 10%;">
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="category_id" @else for="category_id_"{{ $key }} @endif
                                                        class="form-label">Kategori Item</label><span
                                                        style="color: red;">*</span>
                                                    <select
                                                        @if ($key == 0) id="category_id" @else id="category_id_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="category_id[]" required>
                                                        <option>-- Pilih Kategori --</option>

                                                        @foreach ($products as $item)
                                                            <option @if ($value->category_id == $item->id) selected @endif
                                                                value="{{ $item->id }}">{{ $item->product_category }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Nama Produk</label><span
                                                        style="color: red;">*</span>
                                                    <input type="text" class="form-control" id="floatingInput"
                                                ...
                                                <div class="col-md-1 mb-4">
                                                    <label for="select2Basic" class="form-label">Kuantiti</label><span
                                                        style="color: red;">*</span>
                                                    <input id="quantityInput" type="number" min="0"
                                                        class="form-control quantityInput" id="floatingInput"
                                                        placeholder="" aria-describedby="floatingInputHelp"
                                                        name="qty[]" value="{{ $value->qty }}"
                                                        oninput="update_total(this)" required />
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Harga Jual</label><span
                                                        style="color: red;">*</span>
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                        <input id="sellingPriceInput" type="text"
                                                            class="form-control sellingPriceInput" placeholder=""
                                                            aria-label="" aria-describedby="basic-addon11"
                                                            name="selling_price[]" value="{{ $value->selling_price }}"
                                                            oninput="update_total(this)" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="from_bank" @else for="from_bank_"{{ $key }} @endif
                                                        class="form-label">Sumber Dana</label><span
                                                        style="color: red;">*</span>
                                                    <select
                                                        @if ($key == 0) id="from_bank" @else id="from_bank_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="from_bank[]" required>
                                                        <option>-- Pilih Sumber --</option>

                                                        @foreach ($bank as $item)
                                                            <option @if ($value->from_bank == $item->id) selected @endif
                                                                value="bank-{{ $item->id }}" data-source="bank">
                                                                {{ $item->bank_name }}</option>
                                                        @endforeach

                                                        @foreach ($deposit as $item)
                                                            <option @if ($value->deposit_id == $item->id) selected @endif
                                                                value="deposit-{{ $item->id }}"
                                                                data-source="deposit">{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Harga Beli</label><span
                                                        style="color: red;">*</span>
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                        <input id="purchase_price" value="{{ $value->purchase_price }}"
                                                            oninput="update_total_purchase(this)" type="text"
                                                            class="form-control purchase_price" placeholder=""
                                                            aria-label="" aria-describedby="basic-addon11"
                                                ...
                                                <div class="col-md-1 mb-4">
                                                    ...
                                                    <label id="priceLabel" for="select2Basic"
                                                        class="form-label priceLabel">RP.
                                                        {{ number_format($value->total_price_sell, 0) }}</label>
                                                    <input id="total_price_sell" name="total_price_sell[]"
                                                        class="total_price_sell" type="hidden"
                                                        value="{{ $value->total_price_sell }}">
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                        <input type="text" class="form-control debt_to_vendors"
                                                            placeholder="" aria-label=""
                                                            aria-describedby="basic-addon11" name="debt_to_vendors[]"
                                    ...
                                    @else
                                        <div class="row item-row" style="margin-top: 10%;">
                                            <hr>
                                            <div class="col-md-2 mb-4">
                                                <label for="category_id" class="form-label">Kategori Item</label><span
                                                    style="color: red;">*</span>
                                                <select id="category_id" class="select2 form-select form-select-lg"
                                                    data-allow-clear="true" name="category_id[]" required>
                                                    <option>-- Pilih Kategori --</option>
                                            ...
                                            <div class="col-md-1 mb-4">
                                                <label for="select2Basic" class="form-label">Kuantiti</label><span
                                                    style="color: red;">*</span>
                                                <input id="quantityInput" type="number" min="0"
                                                    class="form-control quantityInput" id="floatingInput" placeholder=""
                                                    aria-describedby="floatingInputHelp" name="qty[]"
                                                    oninput="update_total(this)" required />
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="sellingPriceInput" type="text"
                                                        class="form-control sellingPriceInput" placeholder=""
                                                        aria-label="" aria-describedby="basic-addon11"
                                                        name="selling_price[]" oninput="update_total(this)" required />
                                                </div>
                                            </div>

                                            <div class="col-md-2 mb-4">
                                                <label for="from_bank" class="form-label">Sumber Dana</label><span
                                                    style="color: red;">*</span>
                                                <select id="from_bank" class="select2 form-select form-select-lg"
                                                    data-allow-clear="true" name="from_bank[]" required>
                                                    <option>-- Pilih Sumber --</option>

                                                    @foreach ($bank as $item)
                                                        <option value="bank-{{ $item->id }}" data-source="bank">
                                                            {{ $item->bank_name }}</option>
                                                    @endforeach

                                                    @foreach ($deposit as $item)
                                                        <option value="deposit-{{ $item->id }}"
                                                            data-source="deposit">{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                    <input id="purchase_price" oninput="update_total_purchase(this)"
                                                        type="text" class="form-control purchase_price" placeholder=""
                                                        aria-label="" aria-describedby="basic-addon11"
                                                        name="purchase_price[]" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1 mb-4">
                                                <label for="select2Basic" class="form-label">Jumlah</label>
                                                <label id="priceLabel" for="select2Basic"
                                                    class="form-label priceLabel">RP. 0</label>
                                                <input id="total_price_sell" name="total_price_sell[]"
                                                    class="total_price_sell" type="hidden">
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                    <input type="text" class="form-control debt_to_vendors"
                                                        placeholder="" aria-label="" aria-describedby="basic-addon11"
                                                        name="debt_to_vendors[]" oninput="format_debt(this)" />
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            <div class="card-body">
                                <dl class="row mb-0">
                                    ...
                                    <input id="price_selling" name="price_total_selling" type="hidden"
                                        @if (isset($data)) value="{{ $data->price_total_selling }}" @endif>
                                    ...
                                    <input id="price_purchase" name="price_total_purchase" type="hidden"
                                        @if (isset($data)) value="{{ $data->price_total_purchase }}" @endif>
                                    ...
                                    <input id="profit" name="total_profit" type="hidden"
                                        @if (isset($data)) value="{{ $data->total_profit }}" @endif>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <button id="add_cashback" style="float:right; margin-bottom: 5%;" type="button"
                                    class="btn btn-warning">
                                    <i class="ti ti-plus me-sm-1"></i>
                                </button>
                                ...
                                <div id="rowsContainerCashback">
                                        ...
                                        @foreach ($cashback as $key => $item)
                                            <div class="row cashback-row" style="margin-top: 10%;">
                                                <div class="col-md-2 mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                        <input id="nominal_cashback" type="text"
                                                            class="form-control nominal_cashback" placeholder=""
                                                            aria-label="" aria-describedby="basic-addon11"
                                                            name="nominal_cashback[]" value="{{ $item->nominal }}"
                                                            oninput="format_cashback(this)" />
                                                    </div>
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Tanggal</label>
                                                    <input type="date" class="form-control" id="date_cashback"
                                                        name="date_cashback[]" value="{{ $item->date }}" />
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="category_id_cashback" @else for="category_id_cashback_"{{ $key }} @endif
                                                        class="form-label">Kategori Item</label><span
                                                        style="color: red;">*</span>
                                                    <select
                                                        @if ($key == 0) id="category_id_cashback" @else id="category_id_cashback_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="category_id_cashback[]" required>
                                                        <option>-- Pilih Kategori --</option>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="status_cashback" @else for="status_cashback_"{{ $key }} @endif
                                                        class="form-label">Status</label><span
                                                        style="color: red;">*</span>
                                                    <select
                                                        @if ($key == 0) id="status_cashback" @else id="status_cashback_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="status_cashback[]" required>
                                                        <option>-- Pilih Status --</option>
                                                        <option @if ($item->status_cashback == 'Sudah Cair') selected @endif
                                                            value="Sudah Cair">Sudah Cair</option>
                                                        <option @if ($item->status_cashback == 'Belum Cair') selected @endif
                                                            value="Belum Cair">Belum Cair</option>
                                                    </select>
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="bank_id_cashback" @else for="bank_id_cashback_"{{ $key }} @endif
                                                        class="form-label">Dari Bank</label>
                                                    <select
                                                        @if ($key == 0) id="bank_id_cashback" @else id="bank_id_cashback_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="bank_id_cashback[]">
                                                        <option>-- Pilih Bank --</option>

                                                        @foreach ($bank as $item2)
                                                            <option @if ($item->bank_id == $item2->id) selected @endif
                                                                value="{{ $item2->id }}">{{ $item2->bank_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    @else
                                        <div class="row cashback-row" style="margin-top: 10%;">
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="nominal_cashback" type="text"
                                                        class="form-control nominal_cashback" placeholder=""
                                                        aria-label="" aria-describedby="basic-addon11"
                                                        name="nominal_cashback[]" oninput="format_cashback(this)" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                <label for="category_id_cashback" class="form-label">Kategori
                                                    Item</label><span style="color: red;">*</span>
                                                <select id="category_id_cashback"
                                                    class="select2 form-select form-select-lg" data-allow-clear="true"
                                                    name="category_id_cashback[]" required>
                                                    <option>-- Pilih Kategori --</option>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                <label for="status_cashback" class="form-label">Status</label><span
                                                    style="color: red;">*</span>
                                                <select id="status_cashback" class="select2 form-select form-select-lg"
                                                    data-allow-clear="true" name="status_cashback[]" required>
                                                    <option>-- Pilih Status --</option>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <select id="bank_id_cashback" class="select2 form-select form-select-lg"
                                                    data-allow-clear="true" name="bank_id_cashback[]">
                                                    <option>-- Pilih Bank --</option>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <button id="add_tax" style="float:right; margin-bottom: 5%;" type="button"
                                    class="btn btn-warning">
                                    <i class="ti ti-plus me-sm-1"></i>
                                </button>
                                        ...
                                        @foreach ($tax as $key => $item)
                                            <div class="row tax-row" style="margin-top: 10%;">
                                                <div class="col-md-2 mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                        <input id="nominal_tax" type="text"
                                                            class="form-control nominal_tax" placeholder=""
                                                            aria-label="" aria-describedby="basic-addon11"
                                                            name="nominal_tax[]" value="{{ $item->nominal }}"
                                                            oninput="format_tax(this)" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Tanggal</label>
                                                    <input type="date" class="form-control" id="date_cashback"
                                                        name="date_tax[]" value="{{ $item->date }}" />
                                                </div>

                                                <div class="col-md-2 mb-4">
                                                    <label for="select2Basic" class="form-label">Nama Transaksi</label>
                                                    <input type="text" class="form-control" id="name_tax"
                                                        name="name_tax[]" value="{{ $item->transaction_name }}" />
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-4">
                                                    <label
                                                        @if ($key == 0) for="bank_id_tax" @else for="bank_id_tax_"{{ $key }} @endif
                                                        class="form-label">Dari Bank</label>
                                                    <select
                                                        @if ($key == 0) id="bank_id_tax" @else id="bank_id_tax_"{{ $key }} @endif
                                                        class="select2 form-select form-select-lg" data-allow-clear="true"
                                                        name="bank_id_tax[]">
                                                        <option>-- Pilih Bank --</option>
                                        ...
                                        <div class="row tax-row" style="margin-top: 10%;">
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon11">Rp.</span>
                                                    <input id="nominal_tax" type="text"
                                                        class="form-control nominal_tax" placeholder="" aria-label=""
                                                        aria-describedby="basic-addon11" name="nominal_tax[]"
                                                        oninput="format_tax(this)" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                <label for="select2Basic" class="form-label">Tanggal</label>
                                                <input type="date" class="form-control" id="date_tax"
                                                    name="date_tax[]" />
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-4">
                                                ...
                                                <select id="bank_id_tax" class="select2 form-select form-select-lg"
                                                    data-allow-clear="true" name="bank_id_tax[]">
                                                    <option>-- Pilih Bank --</option>
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="customer_form" class="row g-3">
                            ...
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="modalEditUserLastName">Kontak</label><span
                                    style="color: red;"> *</span>
                                <input type="text" id="contact" name="contact" class="form-control"
                                    placeholder="Ketik Kontak" required />
                            </div>

                            <div class="col-12 col-md-4">
                                <label class="form-label" for="modalEditUserName">Email</label><span style="color: red;">
                                    *</span>
                            ...
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="province_id">Provinsi</label><span style="color: red;">
                                    *</span>
                                <select id="province_id" name="province_id" class="select2 form-select"
                            ...
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="district_id">Kecamatan</label><span style="color: red;">
                                    *</span>
                                <select id="district_id" name="district_id" class="select2 form-select"
                                    aria-label="Default select example" required>
                            ...
                            <div class="col-12" style="display: flex; justify-content: flex-end; margin-top: 5%;">
                                ...
                                <button id="submit_customer" type="submit"
                                    class="btn btn-warning me-sm-3 me-1">Buat</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@push('js')
    <script>
        ...
        $('#addRowBtn').click(function() {
            ...
            clonedRow.append(
                '<div class="col-md-12 mb-4" style="display: flex; justify-content: flex-end;"><button type="button" class="btn btn-danger removeRowBtn"><i class="ti ti-trash me-sm-1"></i></button></div>'
                );
        ...
        $('#add_refund').click(function() {
            ...
            clonedRow.append(
                '<div class="col-md-12 mb-4" style="display: flex; justify-content: flex-end;"><button type="button" class="btn btn-danger removeRowBtnRefund"><i class="ti ti-trash me-sm-1"></i></button></div>'
                );
        ...
        $('#add_cashback').click(function() {
            ...
            clonedRow.append(
                '<div class="col-md-12 mb-4" style="display: flex; justify-content: flex-end;"><button type="button" class="btn btn-danger removeRowBtnCashback"><i class="ti ti-trash me-sm-1"></i></button></div>'
                );
        ...
        $('#add_tax').click(function() {
            ...
            clonedRow.append(
                '<div class="col-md-12 mb-4" style="display: flex; justify-content: flex-end;"><button type="button" class="btn btn-danger removeRowBtnTax"><i class="ti ti-trash me-sm-1"></i></button></div>'
                );
